...
export const ContributionText = {
    ...
    "CookBook_Social": {
        ...
        "subHeader": "Features",
        "details": "Design and implementation of homepage recipe feed with various filtering options. Implement 'likes' functionality / popup modal on recipe posts and develop backend Express.js REST API using Firebase cloud functions to manage recipe and user data flow throughout the app.",
