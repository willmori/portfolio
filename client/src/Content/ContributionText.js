...
export const ContributionText = {
    ...
    "Playwright": {
        ...
        "details": "Conducted comprehensive end-to-end testing using Playwright, and developed cloud utility functions to streamline setup and cleanup procedures. Implemented a test suite specifically for the Metalinguist Onboarding process.",
