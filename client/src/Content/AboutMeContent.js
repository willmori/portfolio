...
export const aboutMeContent = {
    "paragraph1": 'Hello! My name is William and I am a recent graduate in Computer Science from the University of California, Santa Barbara. I am primarily a frontend developer, but I also have experience working with the backend (APIs, databases, third party services such as AWS) which I believe is fundamental for any frontend developer to be successful.',
    ...
    "paragraph4": 'Throughout my undergrad in computer science, these are some of the notable courses I took:'
}