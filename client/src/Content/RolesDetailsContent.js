...
export const rolesDetailsContent = {
    ...
    "UCSB_GOLD": {
        ...
        "details": ["Create and design new tables with various filtering options using React",
                    "Redesign certain parts of the admin portal with a focus on improving user experience",
    ...
    "CookBook_Social": {
        ...
        "details": ["Implement custom reusable React components utilizing ES6 JavaScript and Tailwind CSS",
                    "Implement backend Express.js API services using Firebase to manage data throughout the app",
